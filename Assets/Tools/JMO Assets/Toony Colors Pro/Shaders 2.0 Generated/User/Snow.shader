...
Shader "Toony Colors Pro 2/User/Snow"
{
	Properties
	{
		//TOONY COLORS
	...
	Dependency "AddPassShader" = "Hidden/Toony Colors Pro 2/User/Snow-AddPass"
	Dependency "BaseMapShader" = "Hidden/Toony Colors Pro 2/User/Snow-Base"
