...
Shader "Hidden/Toony Colors Pro 2/User/toboggan_terrain-AddPass"
{
	Properties
	{
		//TOONY COLORS
	...
	CGINCLUDE
		#pragma surface surf ToonyColorsCustom decal:add vertex:SplatmapVert_TCP2 finalcolor:SplatmapFinalColor_TCP2
