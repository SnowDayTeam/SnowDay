...
Shader "Hidden/Toony Colors Pro 2/User/sand-AddPass"
{
	Properties
	{
		//TOONY COLORS
	...
	CGINCLUDE
		#pragma surface surf ToonyColorsCustom addshadow decal:add vertex:SplatmapVert_TCP2 finalcolor:SplatmapFinalColor_TCP2
