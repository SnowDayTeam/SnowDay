...
Shader "Toony Colors Pro 2/User/sand"
{
	Properties
	{
		//TOONY COLORS
	...
	Dependency "AddPassShader" = "Hidden/Toony Colors Pro 2/User/sand-AddPass"
	Dependency "BaseMapShader" = "Hidden/Toony Colors Pro 2/User/sand-Base"
